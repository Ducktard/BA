...
//other html
//checkin
import checkinTemplateUrl from '../templates/checkin.html';
...
//statistik
import statsTemplateUrl from '../templates/stats.html';
...
.state('tab.checkin', {
  ...
  views: {
    'tab-create-checkin': {
      templateUrl: checkinTemplateUrl,
...
.state('tab.statistik',{
  url: '/history/statistik',
  views: {
    'tab-history': {
      templateUrl: statsTemplateUrl,
      cache: false,
      controller:  'StatsCntrl as stats'
    }
  }
})
